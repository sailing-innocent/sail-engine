...
void VKBasicApp::initWindow() {
	glfwInit();
	glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);
	m_window = glfwCreateWindow(m_resw, m_resh, m_title.c_str(), nullptr, nullptr);
}

void VKBasicApp::mainLoop() {
	while (tick(0)) {}
	wait();
}

void VKBasicApp::wait() {
	vkDeviceWaitIdle(mDevice);
}

bool VKBasicApp::tick(int count) {
	glfwPollEvents();
	drawFrame();
	return !glfwWindowShouldClose(m_window);
}

void VKBasicApp::cleanup() {
...
void VKBasicApp::createTextureImage() {}

void VKBasicApp::createInstance() {
...
bool VKBasicApp::checkValidationLayerSupport() {
	uint32_t layerCount;
...
std::vector<const char*> VKBasicApp::getRequiredExtensions() {
...
void VKBasicApp::setupDebugMessenger() {
...
void VKBasicApp::pickPhysicalDevice() {
...
void VKBasicApp::createLogicalDevice() {
...
QueueFamilyIndices VKBasicApp::findQueueFamilies(VkPhysicalDevice device) {
...
bool VKBasicApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
SwapChainSupportDetails VKBasicApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool VKBasicApp::isDeviceSuitable(VkPhysicalDevice device) {
	/*
...
VkSurfaceFormatKHR VKBasicApp::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR VKBasicApp::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
// of the window.
VkExtent2D VKBasicApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void VKBasicApp::createSwapChain() {
...
void VKBasicApp::createImageViews() {
...
VkShaderModule VKBasicApp::createShaderModule(const std::vector<char>& code) {
...
void VKBasicApp::createRenderPass() {
...
void VKBasicApp::createDescriptorSetLayout() {}
void VKBasicApp::createDescriptorPool() {}
void VKBasicApp::createDescriptorSets() {}

void VKBasicApp::createGraphicsPipeline() {
	std::vector<char> vertShaderCode;
	dummy::read_file("assets/shaders/vulkan/basic.vert.spv", vertShaderCode);
	std::vector<char> fragShaderCode;
	dummy::read_file("assets/shaders/vulkan/basic.frag.spv", fragShaderCode);
...
void VKBasicApp::createFramebuffers() {
...
void VKBasicApp::createCommandPool() {
	QueueFamilyIndices indices = findQueueFamilies(mPhysicalDevice);
...
void VKBasicApp::createCommandBuffer() {
...
void VKBasicApp::createVertexBuffer() {}
void VKBasicApp::createIndexBuffer() {}
void VKBasicApp::createUniformBuffers() {}

void VKBasicApp::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void VKBasicApp::createSyncObjects() {
...
void VKBasicApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t VKBasicApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void VKBasicApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
	VkCommandBufferAllocateInfo allocInfo{};
	allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
	allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
	allocInfo.commandPool = mCommandPool;
