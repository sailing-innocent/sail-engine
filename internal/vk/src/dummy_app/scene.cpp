...
/**
 * @file scene.cpp
 * @brief The Implementation of Scene
 * @author sailing-innocent
 * @date 2024-05-01
 */
namespace sail::vk {

void VKSceneApp::createDescriptorPool() {
...
void VKSceneApp::createDescriptorSets() {
...
void VKSceneApp::createUniformBuffers() {
...
void VKSceneApp::createDescriptorSetLayout() {
...
void VKSceneApp::calculateFrameStats() {
...
void VKSceneApp::updateUniformBuffer(uint32_t currentImage, dummy::Timer<double>& tmr) {
...
void VKSceneApp::drawFrame(dummy::Timer<double>& tmr) {
...
void VKSceneApp::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void VKSceneApp::createGraphicsPipeline() {
