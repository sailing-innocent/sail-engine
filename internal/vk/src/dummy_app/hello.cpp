/**
 * @file hello.cpp
 * @brief The implementation of VKHelloApp
...
void VKHelloApp::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void VKHelloApp::createVertexBuffer() {
...
void VKHelloApp::createGraphicsPipeline() {
	// --------------EXPOSE path ----------------------------------------------
