/**
 * @file canvas.cpp
 * @brief The Canvas App Implementation
...
VKCanvasApp::VKCanvasApp(const std::string& _vertShaderPath, const std::string& _fragShaderPath) : mVertShaderPath(_vertShaderPath),
																								   mFragShaderPath(_fragShaderPath) {}

bool VKCanvasApp::setVertex(std::vector<float> vfloat, size_t size) {
...
bool VKCanvasApp::setIndex(std::vector<uint16_t> vu16, size_t size) {
...
void VKCanvasApp::createIndexBuffer() {
...
void VKCanvasApp::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void VKCanvasApp::createVertexBuffer() {
...
void VKCanvasApp::createGraphicsPipeline() {
	// std::cout << "Happy Pipeline!" << std::endl;
	std::vector<char> vertShaderCode;
	dummy::read_file(mVertShaderPath, vertShaderCode);

	std::vector<char> fragShaderCode;
	dummy::read_file(mFragShaderPath, fragShaderCode);
...
void VKCanvasApp::createGraphicsPipeline2() {
	// std::cout << "Happy Pipeline!" << std::endl;
	std::vector<char> vertShaderCode;
	dummy::read_file(mVertShaderPath, vertShaderCode);
