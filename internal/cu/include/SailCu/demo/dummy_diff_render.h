...
public:
	...
	[[nodiscard]] void forward_py(int64_t d_source_pix, int h, int w, int64_t d_target_pix) noexcept;
	[[nodiscard]] void backward(
		// input
		float* d_dL_d_target_pix,
		// params
		float* d_dL_d_source_pix) noexcept;
	[[nodiscard]] void backward_py(int64_t d_dL_d_target_pix, int64_t d_dL_d_source_pix) noexcept;
