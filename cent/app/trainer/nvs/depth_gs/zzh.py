...
class GaussianZZHTrainerParams(GaussianTrainerParams):
    def __init__(self):
        super().__init__()
        self.name = "vanilla_params"
        self.opacity_reset_interval = 3000
        self.depth_from_iter = 1000
        self.depth_until_iter = 5000
...
class GaussianTrainer(TrainerBase):
    ...
    def train(self, gaussians, dataset, renderer, loss_fn, params: GaussianZZHTrainerParams):
        ...
        for iteration in range(first_iter, iterations + 1):
            ...
            if iteration > params.depth_from_iter and iteration < params.depth_until_iter:
            ...
            with torch.no_grad():
                ...
                if iteration < params.densify_until_iter:
                    ...
                    if iteration > params.depth_until_iter and iteration % params.opacity_reset_interval == 0 or (iteration == params.densify_from_iter):
