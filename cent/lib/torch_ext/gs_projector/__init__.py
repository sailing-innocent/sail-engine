...
_C = load(
    "rasterize_gaussians", [
        "lib/torch_ext/tile_gs_sampler/rasterize_wrapper.cpp",
        "lib/torch_ext/tile_gs_sampler/rasterize_points.cu",
        "lib/torch_ext/tile_gs_sampler/rasterizer_impl.cu",
        "lib/torch_ext/tile_gs_sampler/forward.cu",
        "lib/torch_ext/tile_gs_sampler/backward.cu"
    ],
    verbose=False,
