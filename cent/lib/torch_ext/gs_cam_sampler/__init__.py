...
_C = load(
    "sample_gaussians", [
        "lib/torch_ext/gs_cam_sampler/sampler_wrapper.cpp",
        "lib/torch_ext/gs_cam_sampler/sampler_points.cu",
        "lib/torch_ext/gs_cam_sampler/sampler_impl.cu",
        "lib/torch_ext/gs_cam_sampler/forward.cu",
        "lib/torch_ext/gs_cam_sampler/backward.cu"
    ],
    verbose=False,
