...
_C = load(
    "rasterize_gaussians", [
        "lib/reimpl/vanilla_diff_gaussian/rasterizer/rasterize_wrapper.cpp",
        "lib/reimpl/vanilla_diff_gaussian/rasterizer/rasterize_points.cu",
        "lib/reimpl/vanilla_diff_gaussian/rasterizer/rasterizer_impl.cu",
        "lib/reimpl/vanilla_diff_gaussian/rasterizer/forward.cu",
