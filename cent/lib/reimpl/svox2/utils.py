...
def _get_c_extension():
    ...
    try:
        print("loading svox2.csrc")
        _C = load(
            "svox2", [
                "lib/reimpl/svox2/csrc/svox2.cpp",
                "lib/reimpl/svox2/csrc/loss_kernel.cu",
                "lib/reimpl/svox2/csrc/misc_kernel.cu",
                "lib/reimpl/svox2/csrc/optim_kernel.cu",
                "lib/reimpl/svox2/csrc/render_lerp_kernel_cuvol.cu",
                "lib/reimpl/svox2/csrc/render_lerp_kernel_nvol.cu",
                "lib/reimpl/svox2/csrc/render_svox1_kernel.cu",
                "lib/reimpl/svox2/csrc/svox2_kernel.cu",
            ],
            verbose=True,
            extra_include_paths=["lib/reimpl/svox2/csrc/include"]
        )
        print("loaded svox2.csrc")
        if not hasattr(_C, "sample_grid"):
            _C = None
    except:
        print("loading svox2.csrc failed")
        _C = None
