...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float, scaling=1.0):
        ...
        self._features = nn.Parameter(features.contiguous().requires_grad_(True))
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._features], 'lr': training_args.feature_lr, "name": "feat"},
    ...
    def save_ply(self, path):
        ...
        f = self._features.detach().contiguous().cpu().numpy()
    ...
    def load_ply(self, path):
        ...
        features = np.zeros((xyz.shape[0], 3))
        features[:, 0] = np.asarray(plydata.elements[0]["f_0"])
        features[:, 1] = np.asarray(plydata.elements[0]["f_1"])
        features[:, 2] = np.asarray(plydata.elements[0]["f_2"])
    ...
    def prune_points(self, mask):
        ...
        self._features = optimizable_tensors["feat"]
        self._opacity = optimizable_tensors["opacity"]
