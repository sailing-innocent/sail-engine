...
namespace ing::test04 {

using namespace ing::rtow;

int test_antialiased() {
	...
	// writing file
	std::ofstream ofs;
	ofs.open("D:/workspace/data/result/rtow/fig_antialiased_rtow.ppm", std::ios::binary);
	ofs << "P6\n"
...
TEST_CASE("rtow_06") {
	REQUIRE(ing::test04::test_antialiased() == 0);
}